...
Int vlan 27
 no shut
 ip add 10.0.65.1 255.255.192.0
ip dhcp excluded-add 10.0.0.65 10.0.0.69
ip dhcp pool TELUSNOC
 network 10.0.0.64 255.255.192.0
 default-router 10.0.65.0
 domain-name TELUSNOC
 dns-server 10.91.1.10
 option 150 ip 10.91.100.8
end
@D2core
